    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Janaki</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/11.jpg" alt="Circle Image" className="img-circle"/>

                    <div className="info-block mt-4">
                        <h3 className="mb-0">Janaki</h3>
                        <p>Surgery Intensive Care Unit</p>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4> 
                    <p>As an experienced specialist in the Surgery Care Unit, I provide comprehensive care to patients undergoing surgical procedures, ensuring optimal outcomes from pre-operative assessments to post-operative recovery. I am skilled in monitoring patient progress, managing complications, and utilizing advanced technology to support recovery.</p>                     
                    <p>My approach combines clinical expertise with compassionate care, working closely with patients and their families to create personalized treatment plans that focus on healing, stability, and long-term recovery.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a Surgery Care specialist, I manage patients before, during, and after surgery. I am skilled in conducting pre-operative assessments, providing post-operative care, and using advanced monitoring systems to ensure safe recovery. My focus is on preventing complications and offering personalized care to promote optimal healing and long-term outcomes.</p>            
                </div>
            <div className="col-lg-4">
