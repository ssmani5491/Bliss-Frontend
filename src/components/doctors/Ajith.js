    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Ajith</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/5.jpg" alt="Circle Image" className="img-circle"/>

                    <div className="info-block mt-4">
                        <h3 className="mb-0">Ajith</h3>
                        <p>Neurology</p>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
<p>As a dedicated neurologist, I specialize in diagnosing and treating a wide range of neurological conditions, from headaches and seizures to complex disorders like Parkinson's disease and multiple sclerosis. With years of experience, I am committed to providing accurate diagnoses and personalized treatment plans to improve my patients' quality of life.</p>
<p>My focus is on clear communication and building strong relationships with my patients. I work closely with them and their families to ensure the best possible care, combining the latest advancements in neurology with compassionate, patient-centered treatment.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a neurologist, I specialize in diagnosing and treating neurological disorders such as epilepsy, Parkinson's disease, stroke, migraines, and multiple sclerosis. I am skilled in interpreting advanced diagnostic tests like EEGs, MRIs, and CT scans, and provide comprehensive care, including medication management, rehabilitation, and patient education on neurological health.</p>
            ...
            <div className="col-lg-4">
                <div className="skill-list">
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Neurological Disorder Management</li>
                        <li><i className="icofont-check mr-2"></i>Epilepsy, Parkinson's, Stroke Care</li>
                        <li><i className="icofont-check mr-2"></i>Migraine & Headache Treatment</li>
                        <li><i className="icofont-check mr-2"></i> Advanced Diagnostics (EEG, MRI, CT)</li>
                        <li><i className="icofont-check mr-2"></i>Neurorehabilitation & Medication</li>
                        </ul>
                </div>
            </div>
            <div className="col-lg-4">
