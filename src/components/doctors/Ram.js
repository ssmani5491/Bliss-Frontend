    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Ram</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/7.jpg" alt="Circle Image" className="img-circle"/>

                    <div className="info-block mt-4">
                        <h3 className="mb-0">Ram</h3>
                        <p>Radiology</p>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
<p>As an experienced orthopedic surgeon, I specialize in diagnosing, treating, and managing musculoskeletal disorders, including bone fractures, joint pain, and spinal conditions. With years of expertise, I am committed to providing effective treatments and rehabilitation plans to help my patients regain mobility and lead pain-free lives.</p>
<p>My approach is focused on clear communication and providing personalized care. I work closely with my patients to develop tailored treatment strategies, combining surgery, physical therapy, and non-surgical treatments to improve their quality of life and mobility.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As an orthopedic surgeon, I specialize in diagnosing and treating musculoskeletal disorders, including bone fractures, joint injuries, arthritis, and spinal conditions. I am skilled in performing surgeries, joint replacements, and non-surgical treatments, along with providing rehabilitation and post-operative care to ensure optimal recovery and mobility.</p>
            ...
            <div className="col-lg-4">
                <div className="skill-list">
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Bone Fractures & Joint Injuries</li>
                        <li><i className="icofont-check mr-2"></i>Spinal Disorders & Deformities</li>
                        <li><i className="icofont-check mr-2"></i>Arthritis & Joint Pain Management</li>
                        <li><i className="icofont-check mr-2"></i>Sports Injuries & Rehabilitation</li>
                        <li><i className="icofont-check mr-2"></i>Post-Surgical Care & Rehabilitation</li>
                        </ul>
                </div>
            </div>
            <div className="col-lg-4">
