    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Murugan</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/4.jpg" alt="Circle Image" className="img-circle"/>

                    <div className="info-block mt-4">
                        <h3 className="mb-0">Murugan</h3>
                        <p>Pediatry</p>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
<p>As a compassionate and dedicated pediatrician, I specialize in the healthcare of children from infancy through adolescence. With years of experience, I am committed to providing comprehensive care to ensure the healthy development of my young patients and address any medical concerns they may have.</p>
<p>My focus is on building trusting relationships with both children and their families. I provide personalized care, promote preventative health practices, and work closely with parents to ensure that each child receives the best possible care for their well-being and growth.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a pediatrician, I specialize in child health and development, diagnosing and treating acute and chronic conditions, providing vaccinations, and offering preventive care. I am skilled in managing pediatric emergencies, promoting healthy lifestyle choices, and supporting families with guidance on nutrition, growth, and behavior.</p>
            ...
            <div className="col-lg-4">
                <div className="skill-list">
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Child Health & Developmen</li>
                        <li><i className="icofont-check mr-2"></i>Acute & Chronic Condition Management</li>
                        <li><i className="icofont-check mr-2"></i>Vaccination & Preventive Care</li>
                        <li><i className="icofont-check mr-2"></i> Pediatric Emergency Care</li>
                        <li><i className="icofont-check mr-2"></i>Growth & Nutritional Guidance</li>
                        </ul>
                </div>
            </div>
            <div className="col-lg-4">
