    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Jaanu</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/6.jpg" alt="Circle Image" className="img-circle"/>

                    <div className="info-block mt-4">
                        <h3 className="mb-0">Jaanu</h3>
                        <p>Psychiatrist</p>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
<p>As a dedicated psychiatrist, I specialize in diagnosing, treating, and managing a wide range of mental health conditions, including depression, anxiety, bipolar disorder, and schizophrenia. With years of experience, I am committed to providing compassionate care and personalized treatment plans to support my patients' mental well-being.</p>
<p>My approach is centered around building trust and clear communication. I work closely with my patients and their families to create tailored treatment plans, utilizing the latest therapies and medication management to help improve their quality of life.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a psychiatrist, I specialize in diagnosing and treating mental health conditions, including depression, anxiety, bipolar disorder, and schizophrenia. I am skilled in providing psychotherapy such as Cognitive Behavioral Therapy (CBT), medication management, stress management, and supporting emotional well-being through personalized treatment plans.</p>
            ...
            <div className="col-lg-4">
                <div className="skill-list">
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Mental Health Diagnosis & Treatment</li>
                        <li><i className="icofont-check mr-2"></i>Depression, Anxiety & Bipolar Disorder Care</li>
                        <li><i className="icofont-check mr-2"></i>Stress Management & Coping Techniques</li>
                        <li><i className="icofont-check mr-2"></i> Medication Management & Therapy</li>
                        <li><i className="icofont-check mr-2"></i>Emotional Well-being & Support</li>
                        </ul>
                </div>
            </div>
            <div className="col-lg-4">
