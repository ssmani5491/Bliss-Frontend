    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Ajay</h1>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4 col-md-6">
                ...
                <img src="images/team/10.jpg" alt="Circle Image" className="img-circle" />


                    <div className="info-block mt-4">
                        <h3 className="mb-0" >Ajay</h3>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4> 
                    <p>As an experienced ICU specialist, I focus on providing critical care to patients with life-threatening conditions, such as severe infections, respiratory failure, trauma, and cardiac emergencies. I am skilled in monitoring and managing complex medical situations, using advanced technology to ensure optimal care and recovery for critically ill patients.</p>
                     <p>My approach integrates clinical expertise with compassionate care, working closely with patients and their families to create personalized treatment plans that prioritize stability, recovery, and long-term health outcomes.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As an ICU specialist, I manage critically ill patients with conditions like respiratory failure, sepsis, and trauma. I am skilled in using advanced monitoring systems, performing emergency procedures, and providing personalized care to ensure optimal recovery and outcomes.</p>            </div>
            <div className="col-lg-4">
                <div className="skill-list">
                    <h5 className="mb-4">Expertise area</h5>
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Managing critically ill patients</li>
                        <li><i className="icofont-check mr-2"></i>Using advanced monitoring systems and life support.</li>
                        <li><i className="icofont-check mr-2"></i>Performing rapid interventions for patient stabilization.</li>
                        <li><i className="icofont-check mr-2"></i>Coordinating care with multidisciplinary teams.</li>
                        <li><i className="icofont-check mr-2"></i>Creating personalized recovery plans.</li>
                        </ul>
                </div>
            </div>
            <div className="col-lg-4">
