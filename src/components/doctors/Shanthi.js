    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Shanthi</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/2.jpg" alt="Circle Image" className="img-circle"/>

                    <div className="info-block mt-4">
                        <h3 className="mb-0">Shanthi</h3>
                        <p>Radiology</p>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
<p>As a highly experienced and dedicated radiologist, I specialize in using advanced imaging techniques to diagnose and monitor a wide range of medical conditions. With years of expertise, I am committed to providing precise and timely results to support the best possible treatment for my patients.</p>
<p>My focus is on clear communication with both patients and healthcare teams. I ensure that every diagnostic image is thoroughly analyzed, and I work closely with medical professionals to provide accurate, actionable insights that guide treatment decisions for optimal patient care.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a radiologist, I specialize in advanced imaging techniques (X-ray, CT, MRI, Ultrasound) for accurate diagnosis. I prioritize patient-centered care, work collaboratively with medical teams, and focus on radiation safety. Continuously learning and utilizing cutting-edge technologies to ensure the best outcomes for my patients.</p>
            ...
            <div className="col-lg-4">
                <div className="skill-list">
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Medical Imaging Techniques</li>
                        <li><i className="icofont-check mr-2"></i>Collaborative Care</li>
                        <li><i className="icofont-check mr-2"></i>Minimizing Patient Risk</li>
                        <li><i className="icofont-check mr-2"></i> Emerging Technologies</li>
                        <li><i className="icofont-check mr-2"></i>Expert Communication</li>
                        </ul>
                </div>
            </div>
            <div className="col-lg-4">
