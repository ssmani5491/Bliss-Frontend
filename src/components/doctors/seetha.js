    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Seetha</h1>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-6">
                <div className="doctor-img-block">
                    <img src="images/team/3.jpg" alt="Circle Image" className="img-circle"/>
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
<p>As a highly skilled and compassionate dentist, I specialize in providing comprehensive dental care, including routine checkups, restorative treatments, and cosmetic procedures. With years of experience, I am committed to improving the oral health and smiles of my patients using the latest techniques and technologies.</p>
<p>My focus is on building long-term relationships with my patients, offering personalized care that addresses their specific dental needs. Whether it’s preventative care or advanced treatments, I prioritize comfort, safety, and ensuring the best outcomes for every patient I treat.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a skilled dentist, I specialize in general and preventive dentistry, restorative procedures like fillings and crowns, cosmetic dentistry including teeth whitening and veneers, orthodontics with braces and aligners, oral surgery, and pediatric dental care. I am committed to delivering personalized care, ensuring optimal oral health and creating beautiful smiles for my patients.</p>
