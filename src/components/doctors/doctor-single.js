    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Anand</h1>
		...
		<div className="row">
			<div className="col-lg-4 col-md-6">
				<div className="doctor-img-block">
					<img src="images/team/1.jpg"alt="Circle Image" className="img-circle"/>

					<div className="info-block mt-4">
						<h3 className="mb-0">Anand</h3>
						<p>Cardiology</p>
			...
			<div className="col-lg-8 col-md-6">
				<div className="doctor-details mt-4 mt-lg-0">
					...
					<h4>About Me</h4>
<p>As a highly skilled and dedicated cardiologist, I specialize in diagnosing, treating, and preventing heart diseases. With years of experience in the field, I am committed to providing my patients with the highest quality of care using the latest techniques and advancements in cardiology.</p>
<p>My focus is on personalized care, where I work closely with each patient to create tailored treatment plans. Whether managing chronic heart conditions or providing preventive care, I ensure that every patient receives compassionate and effective treatment, prioritizing their heart health and overall well-being.</p>
	...
	<div className="container">
		<div className="row">
			<div className="col-lg-4">
				<h3>My skills</h3>
				<div className="divider my-4"></div>
				<p>As a cardiologist, I specialize in diagnosing and treating heart conditions using advanced techniques such as echocardiography, stress tests, and ECG. I am skilled in managing chronic heart diseases, performing diagnostic procedures, and providing personalized care. My focus is on patient education, preventative care, and utilizing the latest advancements to ensure optimal heart health outcomes.</p>
			...
			<div className="col-lg-4">
				<div className="skill-list">
					...
					<ul className="list-unstyled department-service">
						<li><i className="icofont-check mr-2"></i>Cardiovascular Disease Diagnosis</li>
						<li><i className="icofont-check mr-2"></i>ECG & Echocardiography</li>
						<li><i className="icofont-check mr-2"></i>Managing Hypertension & Arrhythmias</li>
						<li><i className="icofont-check mr-2"></i>Preventive Cardiology & Risk Management</li>
						<li><i className="icofont-check mr-2"></i>Interventional Cardiologys</li>
						<li><i className="icofont-check mr-2"></i>Patient-Centered Care</li>
					</ul>
				</div>
			</div>
			<div className="col-lg-4">
