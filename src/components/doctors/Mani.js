    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Mani</h1>
        ...
        <div className="row">
            ...
            <div className="col-lg-8 col-md-6">
                <div className="doctor-details mt-4 mt-lg-0">
                    ...
                    <h4>About Me</h4>
                    <p>I am an experienced orthopedic surgeon with a focus on diagnosing and treating musculoskeletal disorders, including fractures, joint pain, and spinal conditions. With years of expertise, I aim to provide comprehensive care for my patients, ensuring that each receives the most effective treatment plan tailored to their needs.</p>
                    <p>My approach emphasizes clear communication and personalized care. I combine surgical and non-surgical treatments, such as physical therapy and rehabilitation plans, to help patients recover, regain mobility, and improve their quality of life. I am committed to helping individuals lead active, pain-free lives.</p>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-4">
                <h3>My skills</h3>
                <div className="divider my-4"></div>
                <p>As a general medicine professional, I specialize in diagnosing and treating a variety of health conditions, including chronic diseases, infections, and acute illnesses. I focus on providing preventive care, creating personalized treatment plans, and managing long-term conditions to promote overall well-being and healthy living.</p>
            </div>
            <div className="col-lg-4">
