    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">MD/MS</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-8.jpg" alt="" className="img-fluid"/>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                 <h3 className="text-md">MD/MS</h3>
<div className="divider my-4"></div>

<h2>MBBS Training Overview</h2>

<p>
  Our <strong>MD/MS</strong> program is designed for medical professionals aiming to deepen their expertise in specialized fields of medicine. Focused on advanced medical knowledge, clinical skills, and research, this program offers a comprehensive curriculum that equips students to face the evolving challenges in modern healthcare. Participants will receive hands-on training, mentorship from experts, and access to various resources to develop the skills necessary for high-quality medical practice.
</p>

<p>
  Key features of the MD/MSprogram include specializations in various medical disciplines such as <strong><em>Cardiology, Neurology, Surgery, Pediatrics, and more</em></strong>. The program provides opportunities to work alongside experienced faculty members, engage in cutting-edge research projects, and gain familiarity with the latest medical technologies and techniques. Students will also participate in clinical rotations and live-case studies, providing them with invaluable experience in patient care and medical decision-making.
</p>

<p>
  Upon successful completion, graduates will receive internationally recognized certification, opening doors to global medical career opportunities. Whether you aspire to continue in academia, engage in research, or specialize in a specific medical field, the MD/MSprogram lays a solid foundation and offers the guidance needed to achieve your career aspirations.
</p>



<h3 className="mt-5 mb-4">MD/MSTraining Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Advanced Specialization in Medical Fields</li>
    <li><i className="icofont-check mr-2"></i>Experienced Mentors and Renowned Faculty</li>
    <li><i className="icofont-check mr-2"></i>Hands-on Experience in Cutting-edge Medical Technology</li>
    <li><i className="icofont-check mr-2"></i>Comprehensive Research and Clinical Exposure</li>
    <li><i className="icofont-check mr-2"></i>Intensive Medical Workshops and Case Studies</li>
    <li><i className="icofont-check mr-2"></i>International Certifications and Recognition</li>
    <li><i className="icofont-check mr-2"></i>Opportunities for International Medical Exchange Programs</li>
    <li><i className="icofont-check mr-2"></i>Access to World-Class Medical Facilities</li>
    <li><i className="icofont-check mr-2"></i>Comprehensive Job Placement and Career Development</li>
    <li><i className="icofont-check mr-2"></i>Networking with Top Medical Professionals Globally</li>
</ul>
