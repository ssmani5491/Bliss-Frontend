    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">MBBS-UG</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-7.jpg" alt="" className="img-fluid"/>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">MBBS-UG</h3>
                    <div className="divider my-4"></div>
                    <h2>MBBS Training Overview</h2>

      <p>
        The MBBS training program is a comprehensive medical education
        designed for students who wish to become doctors. It is divided into
        multiple phases, starting with foundational subjects such as
        anatomy, physiology, and biochemistry. This phase helps students
        build a strong understanding of the human body and its functions.
      </p>
      <p>
        As students progress, they enter clinical years where they start
        hands-on training in hospitals. During this phase, they gain practical
        experience in diagnosing, treating, and caring for patients under
        supervision by experienced doctors.
      </p>
      <p>
        MBBS training involves extensive theoretical learning coupled with
        practical training. Students are expected to master key medical skills,
        develop strong communication abilities, and cultivate empathy and
        professionalism while interacting with patients.
      </p>

      <h3>Key Phases of the MBBS Program:</h3>
      <ul>
        <li>
          <strong>Phase 1:</strong> Basic Medical Sciences (Year 1 and 2)
        </li>
        <li>
          <strong>Phase 2:</strong> Pre-Clinical and Clinical Training (Year 3 and 4)
        </li>
        <li>
          <strong>Phase 3:</strong> Clinical Rotations (Year 5 and 6)
        </li>
      </ul>

      <p>
        Upon completion of the MBBS program, students are awarded a degree
        that qualifies them to practice medicine. However, most medical
        students go on to pursue further specialization in various fields like
        surgery, internal medicine, pediatrics, etc.
      </p>

      <p>
        This training program is recognized globally and provides students
        with the skills and knowledge required to serve in various healthcare
        settings, from hospitals to research institutions.
      </p>


      <h3 className="mt-5 mb-4">MBBS Training Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Comprehensive Medical Curriculum</li>
    <li><i className="icofont-check mr-2"></i>Expert Faculty with Real-World Experience</li>
    <li><i className="icofont-check mr-2"></i>Hands-on Clinical Practice and Simulations</li>
    <li><i className="icofont-check mr-2"></i>Specialized Workshops in Advanced Medical Fields</li>
    <li><i className="icofont-check mr-2"></i>Internationally Recognized Certifications</li>
    <li><i className="icofont-check mr-2"></i>Job Placement Assistance and Career Guidance</li>
    <li><i className="icofont-check mr-2"></i>Flexible Learning Schedule with Online Options</li>
    <li><i className="icofont-check mr-2"></i>State-of-the-Art Medical Training Facilities</li>
    <li><i className="icofont-check mr-2"></i>Access to Global Networking and Conferences</li>
