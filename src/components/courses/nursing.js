    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Nursing</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-11.jpg" alt="" className="img-fluid"/>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">Nursing</h3>
                    <div className="divider my-4"></div>
                    
                    <h2>Nursing Training Overview</h2>

<p>
  Our Nursing Training program is designed to equip students with the essential skills and knowledge required to excel in the healthcare industry. The program is a comprehensive blend of theory and practice, focusing on critical nursing skills, patient care, and medical knowledge. Students will undergo rigorous training in nursing science, anatomy, physiology, pharmacology, and medical ethics, preparing them to meet the ever-evolving demands of modern healthcare systems.
</p>

<p>
  Throughout the program, students will receive hands-on training in patient care, learning the fundamentals of bedside care, wound management, emergency response, and basic life support. Practical exposure is integrated with classroom learning to ensure students can apply their knowledge in real-world scenarios. In addition to core nursing practices, our curriculum emphasizes communication skills, ethical decision-making, and working collaboratively with other healthcare professionals.
</p>

<p>
  Our nursing students also participate in clinical rotations, which take place in renowned hospitals and healthcare facilities. These rotations allow students to gain valuable experience in diverse areas such as pediatric care, maternal health, geriatric care, surgery, and intensive care. By working directly with patients and healthcare teams, students gain confidence in delivering patient-centered care while honing their clinical skills.
</p>
...
<h3 className="mt-5 mb-4">Nursing PG Training Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Advanced and Specialized Nursing Curriculum</li>
    <li><i className="icofont-check mr-2"></i>Expert Faculty with Specialized Knowledge in Advanced Nursing Fields</li>
    <li><i className="icofont-check mr-2"></i>Hands-on Clinical Training with Complex Patient Cases</li>
    <li><i className="icofont-check mr-2"></i>Advanced Workshops in Critical Care, Pediatric Nursing, Geriatric Nursing, and more</li>
    <li><i className="icofont-check mr-2"></i>Internationally Recognized Nursing Certifications</li>
    <li><i className="icofont-check mr-2"></i>Personalized Career Counseling and Job Placement Assistance</li>
    <li><i className="icofont-check mr-2"></i>Flexible Learning Options with Online Modules for Working Professionals</li>
    <li><i className="icofont-check mr-2"></i>State-of-the-Art Healthcare Facilities and Equipment for Clinical Practice</li>
    <li><i className="icofont-check mr-2"></i>Networking Opportunities at National and International Nursing Conferences</li>
    <li><i className="icofont-check mr-2"></i>Postgraduate Research Opportunities and Specialized Nursing Tracks</li>
</ul>
