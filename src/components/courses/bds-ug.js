    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">BDS-UG</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-9.jpg" alt="" className="img-fluid"/>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">BDS-UG</h3>
                    <div className="divider my-4"></div>
                    <h2>BDS Training Overview</h2>

                    <p>
  Our Bachelor of Dental Surgery (BDS) training program is a comprehensive and advanced curriculum aimed at preparing students to become highly skilled dental professionals. The course is structured to provide a deep understanding of all aspects of dentistry, including clinical, theoretical, and practical components. Students will gain hands-on experience in diagnosing and treating dental conditions, as well as developing strong communication skills to interact with patients and the healthcare team effectively.
</p>
<p>
  Throughout the program, students will study core subjects such as Oral Anatomy, Periodontics, Endodontics, Prosthodontics, Orthodontics, and Oral Pathology. In addition to the fundamental medical sciences, our program emphasizes modern dental techniques, ensuring that students are well-versed in the latest advancements in dental technology. With a focus on hands-on practice in well-equipped dental clinics, students will enhance their practical skills by working on real-world cases under the guidance of experienced instructors.
</p>
<p>
  Our BDS program also includes specialized workshops, where students can gain expertise in advanced dental fields such as implantology, laser dentistry, and cosmetic dentistry. These workshops allow students to develop a strong foundation in both general and specialized dental practices. We also offer opportunities for students to participate in dental camps and internships to further hone their clinical skills and interact with patients in diverse settings.
</p>
<p>
  We understand the importance of providing a supportive learning environment, which is why our program offers individualized attention, mentorship, and career guidance. Students will have access to state-of-the-art dental facilities, equipped with the latest tools and technology, ensuring that they receive world-class training. Our faculty members are experienced dental professionals who are passionate about teaching and dedicated to nurturing the next generation of dental experts.
</p>



<h3 className="mt-5 mb-4">BDS Training Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Comprehensive Dental Curriculum</li>
    <li><i className="icofont-check mr-2"></i>Expert Faculty with Specialized Dental Knowledge</li>
    <li><i className="icofont-check mr-2"></i>Hands-on Clinical Training and Patient Interaction</li>
    <li><i className="icofont-check mr-2"></i>Specialized Workshops in Advanced Dental Techniques</li>
    <li><i className="icofont-check mr-2"></i>Internationally Recognized Dental Certifications</li>
    <li><i className="icofont-check mr-2"></i>Career Counseling and Job Placement Assistance</li>
    <li><i className="icofont-check mr-2"></i>Flexible Training Schedule with Online Options</li>
    <li><i className="icofont-check mr-2"></i>State-of-the-Art Dental Training Facilities</li>
    <li><i className="icofont-check mr-2"></i>Global Networking Opportunities and Dental Conferences</li>
    <li><i className="icofont-check mr-2"></i>Postgraduate Support and Specialization Opportunities</li>
</ul>
