    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">BLS</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-13.jpg" alt="" className="img-fluid"/>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">BLS</h3>
                    <div className="divider my-4"></div>
                    <h2>Basic Life Support (BLS) Training Overview:</h2>

<p>Basic Life Support (BLS) training equips individuals with the skills necessary to provide emergency care in life-threatening situations such as cardiac arrest, choking, and respiratory failure.</p>

<p>BLS is crucial for maintaining circulation, airway, and breathing until advanced medical assistance arrives. It is particularly important for healthcare professionals, first responders, and others who might encounter medical emergencies.</p>

<p>The core elements of BLS training include:</p>

<p><strong>CPR (Cardiopulmonary Resuscitation):</strong> Performing chest compressions and rescue breaths on an unresponsive person to keep the heart and lungs functioning temporarily.</p>

<p><strong>AED (Automated External Defibrillator) Use:</strong> Learning how to use an AED to deliver shocks to a person in cardiac arrest in order to restore a normal heart rhythm.</p>

<p><strong>Choking Management:</strong> Techniques like the Heimlich maneuver to assist someone who is choking and unable to breathe.</p>

<p><strong>Recognizing Cardiac Arrest:</strong> Understanding the signs and symptoms of cardiac arrest and knowing when and how to respond.</p>

<p>BLS training usually involves both theoretical knowledge and hands-on practice to help participants effectively respond to emergencies.</p>

<p>Upon successful completion of the course, participants typically receive certification, which is valid for a period of 2 years, after which a refresher course may be required.</p>

<p>Overall, BLS training empowers individuals with the skills to save lives in critical situations, making it a vital part of emergency preparedness.</p>





<h3 className="mt-5 mb-4">BLS Training Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Comprehensive CPR and AED Training</li>
    <li><i className="icofont-check mr-2"></i>Hands-on Practice with Life-Saving Techniques</li>
    <li><i className="icofont-check mr-2"></i>Certification Recognized by Health Authorities</li>
    <li><i className="icofont-check mr-2"></i>Flexible Learning Options for Busy Professionals</li>
    <li><i className="icofont-check mr-2"></i>Suitable for Healthcare Providers and the General Public</li>
    <li><i className="icofont-check mr-2"></i>Emergency Response Training for Cardiac Arrest and Choking</li>
    <li><i className="icofont-check mr-2"></i>Option for Online and In-Person Training</li>
    <li><i className="icofont-check mr-2"></i>Continuous Access to Educational Resources</li>
    <li><i className="icofont-check mr-2"></i>Post-Certification Support and Refreshers</li>
    <li><i className="icofont-check mr-2"></i>Global Recognition of Training and Certification</li>
</ul>
