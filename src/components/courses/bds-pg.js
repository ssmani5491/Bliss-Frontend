    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">BDS-PG</h1>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">BDS-PG</h3>
                    <div className="divider my-4"></div>
                    <h2>PG Dental Training Overview</h2>

<p>
  Our Postgraduate (PG) Dental Training program is designed for individuals who want to deepen their expertise and specialize in various dental fields. The program offers an advanced curriculum that focuses on both theoretical knowledge and practical skills, providing students with the tools they need to become leaders in the dental profession. With a focus on clinical excellence, research, and specialized areas of dentistry, our PG program ensures that graduates are well-equipped to tackle the complex challenges in modern dental practice.
</p>
<p>
  The PG program covers specialized fields such as Implantology, Orthodontics, Periodontics, Endodontics, Prosthodontics, and Oral Surgery. Students will not only study advanced theoretical concepts but also gain substantial hands-on experience through clinical training, where they will work on complex cases under the mentorship of highly skilled specialists. The program also emphasizes research, enabling students to contribute to the field with new insights and innovations in dental practice.
</p>
<p>
  In addition to specialized training in dental techniques, our PG program includes opportunities for students to participate in advanced workshops and conferences. These events provide exposure to cutting-edge technologies, new treatment methodologies, and global best practices. Our students are encouraged to develop their skills through hands-on experiences and interactive learning in a state-of-the-art clinical environment.
</p>




<h3 className="mt-5 mb-4">BDS PG Training Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Advanced and Specialized Dental Curriculum</li>
    <li><i className="icofont-check mr-2"></i>Experienced Faculty with Expertise in Specialized Dental Fields</li>
    <li><i className="icofont-check mr-2"></i>In-depth Clinical Training and Hands-on Practice with Complex Cases</li>
    <li><i className="icofont-check mr-2"></i>Advanced Workshops in Implantology, Orthodontics, Endodontics, and more</li>
    <li><i className="icofont-check mr-2"></i>Internationally Accredited Dental Certifications</li>
    <li><i className="icofont-check mr-2"></i>Personalized Career Counseling and Job Placement Support</li>
    <li><i className="icofont-check mr-2"></i>Flexible Learning Options with Online Modules for Busy Professionals</li>
    <li><i className="icofont-check mr-2"></i>State-of-the-Art Dental Clinics and Modern Equipment</li>
    <li><i className="icofont-check mr-2"></i>Access to National and International Dental Networking Opportunities</li>
    <li><i className="icofont-check mr-2"></i>Postgraduate Research Opportunities and Specialization Tracks</li>
</ul>
