    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">ACLS</h1>
    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-10.jpg" alt="" className="img-fluid"/>
        ...
        <div className="row">
            <div className="col-lg-8">
                ...
                <h3 className="text-md">ACLS</h3>
<div className="divider my-4"></div>
<h2>ACLS Training Overview</h2>

<p>
  Our <strong>Postgraduate Advanced Cardiovascular Life Support (ACLS)</strong> program is designed for healthcare professionals looking to enhance their skills in managing cardiovascular emergencies. This program combines theoretical knowledge with hands-on practice, ensuring that participants are well-prepared to respond to life-threatening cardiac events. With a focus on advanced resuscitation techniques, teamwork, and critical care, our ACLS training ensures participants are equipped to deliver optimal care in emergency situations.
</p>

<p>
  The ACLS program covers key topics such as <strong>cardiac arrest management, airway management, pharmacology, ECG interpretation, and defibrillation</strong>. Participants will receive comprehensive training in the use of ACLS algorithms and protocols, enabling them to act confidently and efficiently in high-pressure emergency environments. The program includes both lecture-based learning and practical, hands-on experience with state-of-the-art simulation equipment, preparing students to handle a wide range of cardiac emergencies.
</p>

<p>
  Additionally, our ACLS program includes opportunities for students to engage in advanced workshops and scenario-based training. These sessions provide exposure to real-world emergency situations and teach participants to make critical decisions under pressure. Students will benefit from expert guidance and mentorship from experienced instructors, ensuring they receive the highest quality training. Upon successful completion, participants will receive internationally recognized certification that is valid for healthcare providers worldwide.
</p>
...
<h3 className="mt-5 mb-4">ACLS Training Features</h3>
<div className="divider my-4"></div>
<ul className="list-unstyled department-service">
    <li><i className="icofont-check mr-2"></i>Comprehensive ACLS Curriculum Focused on Advanced Cardiovascular Emergencies</li>
    <li><i className="icofont-check mr-2"></i>Experienced Instructors with Expertise in Critical Care and Emergency Medicine</li>
    <li><i className="icofont-check mr-2"></i>Hands-on Training in Advanced Resuscitation Techniques and Life-Saving Skills</li>
    <li><i className="icofont-check mr-2"></i>Practical Scenarios and Simulation-Based Training for Real-World Experience</li>
    <li><i className="icofont-check mr-2"></i>Internationally Recognized ACLS Certification Upon Successful Completion</li>
    <li><i className="icofont-check mr-2"></i>Access to Advanced Workshops in Airway Management, Defibrillation, and ECG Interpretation</li>
    <li><i className="icofont-check mr-2"></i>Flexible Training Schedules to Accommodate Healthcare Professionals</li>
    <li><i className="icofont-check mr-2"></i>Use of High-Fidelity Simulators for Realistic Emergency Situations</li>
    <li><i className="icofont-check mr-2"></i>Opportunities for Networking with Medical Professionals and Instructors</li>
    <li><i className="icofont-check mr-2"></i>Postgraduate Research and Advanced Clinical Practice Opportunities</li>
</ul>
