    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">General Medicine</h1>
		...
		<div className="row">
			<div className="col-lg-8">
				<div className="department-content mt-5">
					...
					<p className="lead">Our healthcare services focus on your overall well-being, offering expert care for a range of conditions with a commitment to prevention and healing.</p>
					<p>At our facility, we prioritize your health by offering comprehensive medical services that address a wide range of conditions. Our expert doctors and healthcare providers deliver personalized care, combining advanced treatments and therapies to ensure optimal outcomes. We emphasize prevention, early detection, and education, empowering you to make informed decisions about your health. From managing chronic conditions to providing acute care, our team is dedicated to improving your overall well-being and enhancing your quality of life.</p>


					<h3 className="mt-5 mb-4">Services features</h3>
					<div className="divider my-4"></div>
					<ul className="list-unstyled department-service">
						<li><i className="icofont-check mr-2"></i>Emergency Care</li>
						<li><i className="icofont-check mr-2"></i>General Medicine</li>
						<li><i className="icofont-check mr-2"></i>Maternity & Obstetrics</li>
						<li><i className="icofont-check mr-2"></i>Rehabilitation Services</li>
						<li><i className="icofont-check mr-2"></i>Patient Support Services</li>
