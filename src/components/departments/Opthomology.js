    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Opthomology</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-3.jpg" alt="" className="img-fluid"/>
                </div>
            </div>
        </div>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">Opthomology</h3>
                    <div className="divider my-4"></div>
                    <p>Ophthalmology is the branch of medicine that focuses on the diagnosis, treatment, and prevention of eye diseases and disorders. Ophthalmologists provide comprehensive eye care, ranging from routine vision exams and corrective treatments (like glasses and contact lenses) to advanced surgical interventions for conditions such as cataracts, glaucoma, and retinal diseases. Early detection and management are key components of ophthalmology to ensure long-term eye health.</p>

<p>Ophthalmology services also include specialized treatments for conditions like macular degeneration, diabetic retinopathy, and corneal diseases. Patients can receive laser treatments, eye surgery, and post-operative care to restore or preserve vision. Preventive care and education on eye health, including UV protection and proper nutrition, also play an essential role in maintaining good vision throughout life.</p>
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Comprehensive Eye Exams</li>
                        <li><i className="icofont-check mr-2"></i>Cataract Surgery</li>
                        <li><i className="icofont-check mr-2"></i>Laser Eye Surgery</li>
                        <li><i className="icofont-check mr-2"></i>Diabetic Retinopathy Management</li>
                        <li><i className="icofont-check mr-2"></i>Corneal Disease Management</li>
                        <li><i className="icofont-check mr-2"></i>Emergency Eye Care</li>
                    </ul>
