		...
		<div className="row justify-content-center">
			<div className="col-lg-7 text-center">
				<div className="section-title">
					...
					<p>
					We provide award-winning patient care, prioritizing comfort, compassion, and exceptional treatment.</p>
				</div>
			</div>
		</div>
		...
		<div className="col-lg-4 col-md-6">
				<div className="department-block mb-5">
					...
					<div className="content">
						<h4 className="mt-4 mb-2 title-color">General Medicine</h4>
						<p className="mb-4">
						We provide high-quality dental care to ensure your smile stays healthy and bright.</p>
						<a href="generalmedicine" className="read-more">Learn More <i className="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6">
				<div className="department-block mb-5">
					...
					<div className="content">
						...
						<p className="mb-4">We offer comprehensive cardiology services to ensure your heart health is in expert hands.</p>
						<a href="cardiology" className="read-more">Learn More <i className="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6 ">
				<div className="department-block mb-5">
					...
					<div className="content">
						...
						<p className="mb-4">
						We provide expert ophthalmology care for all your eye health needs.</p>
						<a href="opthomology" className="read-more">Learn More  <i className="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6">
				<div className="department-block mb-5">
					...
					<div className="content">
						...
						<p className="mb-4">
						We provide high-quality dental care to ensure your smile stays healthy and bright.</p>
						<a href="dentalcare" className="read-more">Learn More <i className="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6">
				<div className="department-block mb-5 mb-lg-0">
					...
					<div className="content">
						...
						<p className="mb-4">We offer specialized pulmonology care to treat and manage respiratory conditions effectively.</p>
						<a href="pulmology" className="read-more">Learn More <i className="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6">
				<div className="department-block mb-5 mb-lg-0">
					...
					<div className="content">
						...
						<p className="mb-4">
						We provide comprehensive gynecology services to support women's health at every stage of life.</p>
						<a href="gynecology" className="read-more">Learn More <i className="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
		</div>
...
<footer className="footer ">
  ...
  <div className="widget mb-5 mb-lg-0"><br></br><br></br><br></br>
    ...
    <script src="assets/https://maps.googleapis.com/maps/api/js?key=AIzaSyAkeLMlsiwzp6b3Gnaxd86lvakimwGA6UA&callback=initMap"></script>    
