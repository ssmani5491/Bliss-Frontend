    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Dental Care</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-4.jpg" alt="" className="img-fluid"/>
                </div>
            </div>
        </div>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">Dental Care</h3>
                    <div className="divider my-4"></div>
                    <p>Dental care encompasses a wide range of services aimed at maintaining oral health, preventing tooth and gum diseases, and restoring function and aesthetics to teeth. General dentistry includes routine checkups, cleanings, fillings, and treatments for common dental issues like cavities and gum disease. Early detection and regular dental exams play a critical role in preventing more serious conditions such as tooth loss or infections.</p>

<p>Advanced dental services include cosmetic dentistry, such as teeth whitening, veneers, and orthodontics (braces), as well as restorative procedures like crowns, bridges, and dental implants. Dental professionals also focus on patient education regarding oral hygiene practices, diet, and the importance of regular dental visits to ensure long-term dental health.</p>
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Routine Checkups & Cleanings</li>
                        <li><i className="icofont-check mr-2"></i>Teeth Whitening</li>
                        <li><i className="icofont-check mr-2"></i>Orthodontics</li>
                        <li><i className="icofont-check mr-2"></i>Root Canal Treatment</li>
                        <li><i className="icofont-check mr-2"></i>Gum Disease Treatment</li>
                        <li><i className="icofont-check mr-2"></i>Emergency Dental Care</li>
                    </ul>
