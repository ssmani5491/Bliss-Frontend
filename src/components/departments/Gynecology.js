    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Gynecology</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-6.jpg" alt="" className="img-fluid"/>
                </div>
            </div>
        </div>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">Gynecology</h3>
                    <div className="divider my-4"></div>
                    <p>Gynecology is a branch of medicine focused on the health of the female reproductive system. Our gynecological services include routine exams, menstrual disorder management, and specialized care for pregnancy, including prenatal and postnatal care. We also offer family planning services, infertility treatments, and screenings for conditions like cervical and breast cancer to ensure early detection and prevention of potential health risks.</p>

<p>Our gynecology services also extend to managing menopause symptoms, pelvic pain, and conditions such as endometriosis. For women facing high-risk pregnancies, we provide expert care to ensure both mother and baby are supported. In addition, we offer advanced gynecological surgeries such as hysterectomies and fibroid removal, ensuring a holistic approach to female health at all stages of life.</p>
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Routine Gynecological Exams</li>
                        <li><i className="icofont-check mr-2"></i>Menstrual Disorder Management</li>
                        <li><i className="icofont-check mr-2"></i>Infertility Treatment</li>
                        <li><i className="icofont-check mr-2"></i>Menopause Management</li>
                        <li><i className="icofont-check mr-2"></i>Pelvic Pain and Endometriosis Care</li>
                        <li><i className="icofont-check mr-2"></i>High-Risk Pregnancy Management</li>
                    </ul>
