    ...
    <div className="row">
      <div className="col-md-12">
        <div className="block text-center">
          ...
          <h1 className="text-capitalize mb-5 text-lg">Pulmology</h1>
        ...
        <div className="row">
            <div className="col-lg-12">
                <div className="department-img">
                    <img src="images/service/bg-5.jpg" alt="" className="img-fluid"/>
                </div>
            </div>
        </div>
        ...
        <div className="row">
            <div className="col-lg-8">
                <div className="department-content mt-5">
                    <h3 className="text-md">Pulmology</h3>
                    <div className="divider my-4"></div>
                    <p>Pulmonology is the branch of medicine that focuses on diagnosing, treating, and managing respiratory conditions and diseases of the lungs. Our pulmonology services include the treatment of asthma, chronic obstructive pulmonary disease (COPD), pneumonia, lung infections, and other breathing disorders. We also provide comprehensive care for conditions like sleep apnea, pulmonary fibrosis, and lung cancer.</p>

<p>Our expert pulmonologists use advanced diagnostic tools, such as pulmonary function tests, chest X-rays, and bronchoscopy, to accurately diagnose and treat respiratory issues. We offer both medical management and pulmonary rehabilitation programs to help patients improve their lung function, manage symptoms, and maintain a healthy, active lifestyle.</p>
                    ...
                    <ul className="list-unstyled department-service">
                        <li><i className="icofont-check mr-2"></i>Comprehensive Respiratory Checkups</li>
                        <li><i className="icofont-check mr-2"></i>Asthma Management</li>
                        <li><i className="icofont-check mr-2"></i>Pulmonary Rehabilitationy</li>
                        <li><i className="icofont-check mr-2"></i>Pneumonia and Lung Infection Care</li>
                        <li><i className="icofont-check mr-2"></i>Smoking Cessation Programs</li>
                        <li><i className="icofont-check mr-2"></i>Pulmonary Function Testing</li>
                    </ul>
