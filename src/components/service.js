		...
		<div className="row">
			<div className="col-lg-4 col-md-6 col-sm-6">
				<div className="service-block mb-5">
					...
					<div className="content">
						...
						<p className="mb-4">We provide compassionate and expert healthcare tailored to meet the unique needs of your child.</p>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6 col-sm-6">
				<div className="service-block mb-5">
					...
					<div className="content">
						...
						<p className="mb-4">We offer personalized care tailored to your unique health needs.</p>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6 col-sm-6">
				<div className="service-block mb-5">
					...
					<div className="content">
						...
						<p className="mb-4">We provide accurate and reliable CT scans for detailed diagnostic insights.</p>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6 col-sm-6">
				<div className="service-block mb-5 mb-lg-0">
					...
					<div className="content">
						...
						<p className="mb-4">We offer expert joint replacement surgery to restore mobility and improve quality of life.</p>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6 col-sm-6">
				<div className="service-block mb-5 mb-lg-0">
					...
					<div className="content">
						...
						<p className="mb-4">
						We provide thorough examination and accurate diagnosis to ensure the best treatment plan.</p>
					</div>
				</div>
			</div>
			...
			<div className="col-lg-4 col-md-6 col-sm-6">
				<div className="service-block mb-5 mb-lg-0">
					...
					<div className="content">
						<h4 className="mt-4 mb-2 title-color">Pediatric Care</h4>
						<p className="mb-4">We offer compassionate pediatric care to ensure your child's health and well-being.</p>
					</div>
				</div>
			</div>
		</div>
